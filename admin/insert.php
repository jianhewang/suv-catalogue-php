	...
	<form name="myForm" class="my-4 flex-grow-1 px-0" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
		...
		<div class="form-row">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="fuel" id="gas" value="g" <?php if($_POST['fuel'] == "g") {echo "checked";} ?>>
            <label class="form-check-label" for="gas">
              Gasoline
            </label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="fuel" id="diesel" value="d" <?php if($_POST['fuel'] == "d") {echo "checked";} ?>>
            <label class="form-check-label" for="diesel">
              Diesel
            </label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="fuel" id="electric" value="e" <?php if($_POST['fuel'] == "e") {echo "checked";} ?>>
            ...
            <?php endif; ?>
				...
				<div class="form-group">
					...
					<textarea class="form-control" name="desc" id="desc" placeholder="Max 500 characters..."><?php echo $desc; ?></textarea>
		...
		<a href="<?php echo BASE_URL ?>admin/welcome.php" class="btn btn-info">Cancel</a>
		<button type="submit" class="btn btn-primary my-3" name="submit">Submit</button>
		<button type="submit" class="btn btn-secondary my-3" name="reset">Reset</button>
	</form>
